...
async function resolve(
  ...
  // Always treat localhost/hardhat as mock for development
  ...
  // For localhost chainId 31337, always use mock
  if (chainId === 31337 || Object.hasOwn(_mockChains, chainId)) {
    if (!rpcUrl) {
      rpcUrl = _mockChains[chainId] || "http://localhost:8545";
    }
